...
The goal of zxcvbn4r is to provide an **R** binding to the [zxcvbn-cli](https://github.com/gamontal/zxcvbn-cli) library.
...
You can install the released version of zxcvbn4r from [Github](https://github.com/CarlBoneri/zxcvbn4r) with:
